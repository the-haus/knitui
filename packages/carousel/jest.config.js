/**
 * Jest config for unit-testing @knitui/carousel with React Testing Library.
 *
 ...
 * environment, so the engine + web controller get real coverage with no
 * native-module mocking. The pure engine (src/engine) is plain TS and is
 * exercised directly — it has no React, DOM, or reanimated imports.
 *
