/**
 * Jest config for unit-testing @knitui/mediaquery. Hooks render on the WEB target
 * via react-native-web in a jsdom environment (so `renderHook` has a DOM and any
