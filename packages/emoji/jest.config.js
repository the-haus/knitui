/**
 * Jest config for @knitui/emoji. The smoke suite exercises the WEB emoji renderer
 * (`internal/create-emoji.tsx`, picked over the `.native` split since jest doesn't
