export const zoomstackNightStyle = {
  version: 8,
  name: "OS Open Zoomstack - Night",
  metadata: {
  ...
  sources: {
    zoomstack: {
      type: "vector",
      tiles: ["https://demo.ldproxy.net/zoomstack/tiles/WebMercatorQuad/{z}/{y}/{x}?f=mvt"],
      scheme: "xyz",
      maxzoom: 14,
    },
  },
  sprite: "https://demo.ldproxy.net/zoomstack/resources/sprites",
  glyphs: "https://demo.ldproxy.net/zoomstack/resources/{fontstack}__{range}.pbf",
  layers: [
    {
      id: "background",
      type: "background",
    ...
    },
    {
      ...
      paint: {
        "fill-color": "#163838",
        "fill-opacity": ["interpolate", ["linear"], ["zoom"], 5, 0.6, 9, 0.5, 12, 0.1],
      },
    },
    {
      id: "urban-areas",
    ...
    },
    {
      ...
      paint: {
        "line-color": "hsl(169, 45%, 11%)",
        "line-width": ["interpolate", ["linear"], ["zoom"], 10, 0.1, 15, 0.3, 18, 0.6],
      },
    },
    {
      id: "woodland",
    ...
    },
    {
      ...
      "source-layer": "roads",
      minzoom: 10,
      filter: ["match", ["get", "type"], ["Primary", "Motorway"], false, true],
      layout: {
        "text-field": ["to-string", ["get", "number"]],
        "symbol-placement": "line",
        "text-max-angle": 45,
        "text-size": ["interpolate", ["linear"], ["zoom"], 10, 8, 15, 11, 22, 28],
    ...
    },
    {
      ...
      layout: {
        ...
        "symbol-placement": "line",
        "text-font": ["Source Sans Pro Regular"],
        "text-size": ["interpolate", ["linear"], ["zoom"], 10, 8, 15, 10, 22, 25],
        "symbol-spacing": ["interpolate", ["linear"], ["zoom"], 10, 25, 15, 97, 17, 250],
        "text-max-angle": 82,
        "text-padding": 1,
      },
      paint: {
    ...
    },
    {
      ...
      layout: {
        ...
        "symbol-placement": "line",
        "text-max-angle": 65,
        "text-size": ["interpolate", ["linear"], ["zoom"], 9, 8.5, 15, 12, 22, 28],
    ...
    },
    {
      ...
      layout: {
        ...
        "symbol-placement": "line",
        "text-max-angle": 45,
        "text-size": ["interpolate", ["linear"], ["zoom"], 8, 8.5, 10, 9, 15, 12, 22, 28],
        "text-font": ["Source Sans Pro SemiBold"],
        "text-letter-spacing": 0.1,
    ...
    },
    {
      ...
      layout: {
        ...
        "text-size": ["interpolate", ["linear"], ["zoom"], 13, 11, 16, 16, 22, 30],
        "text-font": ["Source Sans Pro Bold"],
      },
      paint: {
        "text-color": "#ffffff",
        "text-halo-color": "#3c5472",
        "text-halo-width": 10,
      },
    },
    {
