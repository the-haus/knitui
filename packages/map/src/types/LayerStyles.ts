// Cross-platform layer style types
// Ported from maplibre-react-native MapLibreRNStyles.ts
...
export interface SymbolLayerStyle {
   ...
   * @requires textField
   */
  textRotationAlignment?: Value<"map" | "viewport" | "viewport-glyph" | "auto", ["zoom"]>;
  /**
   ...
   * @requires textField
   */
  textJustify?: Value<"auto" | "left" | "center" | "right", ["zoom", "feature"]>;
  /**
   ...
   * @requires textField
   */
  textTransform?: Value<"none" | "uppercase" | "lowercase", ["zoom", "feature"]>;
  /**
