/**
 * Stub for `react-native/Libraries/Image/AssetRegistry` in the @knitui/media
 * Storybook.
 *
 * Some RN-targeting modules lazily
 ...
 * resolve it. The media stories only use string image URLs, never numeric
...
export function getAssetByID() {
  throw new Error(
    "[@knitui/media] Numeric/require()'d image assets aren't supported on web in Storybook — use a URL string source instead.",
  );
}
