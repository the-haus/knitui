...
function PlaylistPlayer() {
  const playlist = useAudioPlaylist({
    sources: [require("./track1.mp3"), require("./track2.mp3"), "https://example.com/track3.mp3"],
    loop: "all",
  });
  ...
  return (
    <View>
      ...
      <Button
        title={playlist.playing ? "Pause" : "Play"}
        onPress={() => (playlist.playing ? playlist.pause() : playlist.play())}
      />
...
Type: Class extends [SharedObject](/versions/v56.0.0/sdk/expo.md#sharedobjecttype)<[AudioEvents](#audioevents)\>
...
Type: Class extends [SharedObject](/versions/v56.0.0/sdk/expo.md#sharedobjecttype)<[AudioPlaylistEvents](#audioplaylistevents)\>
...
Type: Class extends [SharedObject](/versions/v56.0.0/sdk/expo.md#sharedobjecttype)<[RecordingEvents](#recordingevents)\>
...
Type: Class extends [SharedObject](/versions/v56.0.0/sdk/expo.md#sharedobjecttype)<[AudioStreamEvents](#audiostreamevents)\>
